    ...
    <div className="text-center py-10 bg-gray-100">
      ...
      <div className="flex justify-center space-x-4 mb-8">
        <div className="w-1/5 bg-white shadow-lg rounded-lg overflow-hidden">
          <img src="/img/8.jpg" alt="Awareness Projects" className="w-full h-48 object-cover" />
          <h3 className="text-xl mt-4 mb-4">Education </h3>
        </div>
        <div className="w-1/5 bg-white shadow-lg rounded-lg overflow-hidden">
          <img src="/img/7.jpg" alt="Education Projects" className="w-full h-48 object-cover" />
          <h3 className="text-xl mt-4 mb-4">Awareness </h3>
        </div>
        <div className="w-1/5 bg-white shadow-lg rounded-lg overflow-hidden">
          <img src="/img/9.jpg" alt="Humanitarian Projects" className="w-full h-48 object-cover" />
